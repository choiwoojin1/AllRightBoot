package com.icia.allrightboot.service;

import com.icia.allrightboot.dao.MDAO;
import com.icia.allrightboot.dto.*;
...
public class MService {
    ...
    public ModelAndView mJoin(MEMBER member) throws IOException {
        ...
        String savePath = "C:/springBootWorkspace/AllRight1/src/main/resources/static/profile/"+mLicenceName;
        // (6) 파일 선택여부
        if(!mLicence.isEmpty()){
    ...
    public ModelAndView qWrite(QUESTION question) throws IOException {
        ...
        String savePath = "C:/springBootWorkspace/AllRight1/src/main/resources/static/profile/"+qFileName;
        // (6) 파일 선택여부
        if(!qFile.isEmpty()){
    ...
    public ModelAndView reModify(REVIEW review) throws IOException {
        ...
        // (5) 파일 저장위치
        String savePath = "C:/springBootWorkspace/AllRight1/src/main/resources/static/profile/"+reFileName;
